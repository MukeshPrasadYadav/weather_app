  ...
  return (
    <div className="relative flex flex-col items-center text-white w-full min-h-screen gap-6">
      ...
      <div className="relative z-10 flex flex-col sm:flex-row w-full justify-around items-center gap-4 px-4">
        <form id="inputForm" onSubmit={handleSubmit} className="flex w-fit justify-between gap-0 sm:w-auto bg-white/10 rounded-md overflow-hidden">
          <input
          ...
          />
          <button type="submit" className="w-fit cursor-pointer rounded  bg-green-500 p-2">Search</button>
        </form>
